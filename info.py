...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002750225419 -1001769437975 -1002990775643').split()]  # For Multiple Id Use One Space Between Each.
