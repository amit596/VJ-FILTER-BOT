...
PICS = (environ.get('PICS', 'https://graph.org/file/5b007c93c6d069a4cf3d3.jpg')).split() #SAMPLE PIC
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002147445817 -1002238586253').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', ' -1001868803671 -1001785093771 -1002198396079') # give your force subscribe channel id here else leave it blank
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ak_adulthub')
