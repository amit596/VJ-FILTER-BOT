...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001855645227 -1002185920343').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/akrequestgroup') # Support Chat Link Without https:// or @
